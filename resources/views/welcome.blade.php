<x-layout>
    <div class="px-40 mx-40 my-20 text-center">
        <h1 class="text-mega font-serif text-white">The place to <span class="bg-gradient-to-br from-blue to-aqua text-transparent bg-clip-text">collect, track, and discover</span> your media.</h1>
    </div>
