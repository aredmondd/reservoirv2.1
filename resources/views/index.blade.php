<x-layout>
    ...
    <div class="rounded-md p-3">
        <div class="flex mx-36 justify-around">
            ...
            <x-add-movie-ad img="images/movie_posters/joker.jpeg" name="Joker" desc="Arthur Fleck, a party clown and a failed stand-up comedian, leads an impoverished life with his ailing mother. However, when society shuns him and brands him as a freak, he decides to embrace the life of crime and chaos in Gotham City."></x-add-movie-ad>
        </div>
    </div>
